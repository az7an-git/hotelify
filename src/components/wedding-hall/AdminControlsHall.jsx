            ...
            <div className="flex gap-4 mt-4">
              ...
              {booking.status === "Accepted" && (
                <button
                  ...
                  className="px-5 py-2 font-semibold bg-blue-500 text-slate-800 rounded-full shadow-md transform transition hover:bg-blue-600 hover:-translate-y-1 focus:ring focus:ring-blue-200"
                >
                  Delivered
                </button>
              )}
