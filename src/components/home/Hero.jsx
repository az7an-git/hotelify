  ...
  return loading ? (
    ...
    >
      ...
      <div className="relative z-10 text-center px-4 sm:px-6 w-[96%] sm:w-[92%] max-w-4xl mx-auto space-y-4 md:space-y-6 glass-card p-4 sm:p-6 md:p-12 mt-4">
        <h1 className="text-3xl md:text-6xl font-extrabold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 via-indigo-600 to-purple-600 animate-slide-up pb-2">
        ...
        <div className="pt-2 sm:pt-4 animate-slide-up">
          <Link
            to="/room-booking"
            className="glass-button-primary inline-block px-6 py-2.5 sm:px-8 sm:py-3.5 rounded-full text-base sm:text-lg shadow-blue-500/20 hover:shadow-blue-500/40"
          >
            <span>Book Now</span>
          </Link>
        </div>
