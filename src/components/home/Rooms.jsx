  ...
  const fallbackRooms = [
    {
      ...
      beds: 1,
      description: "A spacious room featuring a plush king-size bed, elegant modern decor, and a beautiful view of the city skyline.",
      price: 150
    },
    {
      id: "fallback-r2",
      ...
      beds: 2,
      description: "Perfect for colleagues or family. Features two comfortable double beds, a dedicated study desk, and luxurious amenities.",
      price: 180
    },
    {
      id: "fallback-r3",
      name: "Magnum Presidential Suite",
      imageUrl: "https://images.unsplash.com/photo-1591088398332-8a7791972843?auto=format&fit=crop&w=600&q=80",
      beds: 3,
      description: "Our signature suite offering ultimate luxury, expansive separate living area, dining zone, and a panoramic balcony view.",
      price: 350
    }
  ];

  const displayedRooms = rooms && rooms.length > 0 ? rooms : (rooms ? fallbackRooms : []);
